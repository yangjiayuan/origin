...
namespace YUANYE
{
    ...
    public class clsPayment : ToolDetailForm
    {
        ...
        public override Form GetForm(CRightItem right, Form mdiForm)
        {
             ...
             try
            {
                ...
                this.MainTableName = "D_Payment";
                Filter = string.Format("D_Payment.Paymenttype={0}", (int)PaymentType);
                ...
                defaultValue.Add("D_Payment", Value);
