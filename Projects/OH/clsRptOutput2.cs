...
namespace OH
{
    public class clsRptOutput2 : BaseReport
    {
        public override bool Initialize()
        {
            _Title = "产量查询2";
            _SQL = "select   " +
                            "H.DepartName,G.ProcessName,A.IsRework,J.OperatorName ${ShowMaterial}," +
                            ...
                            "sum(C.Amount) Amount " +
                        "from D_workorder A,D_WorkOrderProduct B ," +
                        ...
                        "${Where} " +
                        "group by H.DepartName,G.ProcessName,A.IsRework,J.OperatorName ${ShowMaterial}";
            _IsAppendSQL = false;
            _IsWhere = false;
