...
namespace OH
{
    public class CVendorStorage : ToolDetailForm
    {
        ...
        public override Form GetForm(CRightItem right, Form mdiForm)
        {
            ...
            { 
                ...
                _mdiForm = mdiForm;
                this.MainTableName = "V_VendorConsignStorageData";
                Filter = string.Format("V_VendorConsignStorageData.Quantity >0 ");
            ...
            {
                Msg.Warning(string.Format("供应商寄售库存程序加载失败！%n {0}", ex.Message));
            }
            return null;
