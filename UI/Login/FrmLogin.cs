...
namespace GUI.Login
{
	...
	public partial class FrmLogin : Form
	{
        ...
        {
            System.Diagnostics.Process.Start("http://www.shsifeng.com/cn/index.asp");
        }
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            if (!(_CheckUserAndPasswordTextBox()))
                ...
                MessageBox.Show(MultiLanguageStrings.GetString(Ressource.PasswordForm, "messageBoxUserPasswordBlank.Text"), "",
